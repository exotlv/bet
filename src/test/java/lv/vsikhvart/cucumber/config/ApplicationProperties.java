            ...
            put("default", new Properties() {
                {
                    ...
                    //application URL's
                    setProperty(ApplicationProperty.APP_URL.name, "https://www.optibet.lt/");
                    ...
                    setProperty(ApplicationProperty.TEST_USER_NAME.name, "betest@mailinator.com");
                    setProperty(ApplicationProperty.TEST_USER_PASSWORD.name, "Betest@123");
