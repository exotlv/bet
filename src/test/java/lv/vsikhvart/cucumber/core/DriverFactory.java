...
import static lv.vsikhvart.cucumber.config.ApplicationProperties.ApplicationProperty.BROWSER;
import static lv.vsikhvart.cucumber.config.ApplicationProperties.ApplicationProperty.DESIRED_BROWSER_VERSION;
import static lv.vsikhvart.cucumber.config.ApplicationProperties.ApplicationProperty.DESIRED_PLATFORM;
import static lv.vsikhvart.cucumber.config.ApplicationProperties.ApplicationProperty.ENABLE_VIDEO;
import static lv.vsikhvart.cucumber.config.ApplicationProperties.ApplicationProperty.ENABLE_VNC;
import static lv.vsikhvart.cucumber.config.ApplicationProperties.ApplicationProperty.PROXY_ENABLED;
import static lv.vsikhvart.cucumber.config.ApplicationProperties.ApplicationProperty.PROXY_HOST;
import static lv.vsikhvart.cucumber.config.ApplicationProperties.ApplicationProperty.PROXY_PORT;
import static lv.vsikhvart.cucumber.config.ApplicationProperties.ApplicationProperty.REMOTE_DRIVER;
import static lv.vsikhvart.cucumber.config.ApplicationProperties.ApplicationProperty.SELENIUM_GRID_RETRY_COUNT;
import static lv.vsikhvart.cucumber.config.ApplicationProperties.ApplicationProperty.SELENIUM_GRID_URL;
import static lv.vsikhvart.cucumber.core.DriverType.FIREFOX;
import static lv.vsikhvart.cucumber.core.DriverType.valueOf;
